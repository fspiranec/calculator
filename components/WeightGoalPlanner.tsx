...
export default function WeightGoalPlanner({ entries, onApplyCalorieAdjustment }: { entries: WeightEntry[]; onApplyCalorieAdjustment?: (adjustment: number) => void }) {
